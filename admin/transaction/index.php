        ...
        <div class="content_admin">
            <!-- FORM REPORT -->
                <div class="report_section">
                    <h1>Buat Laporan Penjualan Bulanan</h1>
                    <form action='../print/printreport.php' method="GET" target="_self">
                        ...
                        <button type="submit" class="btn btn-primary">Lihat Laporan Bulanan</button>
                    </form>
                </div>
                <!-- FORM REPORT -->
