...
// if (!isset($_POST['subkategori_tp']) || empty($_POST['subkategori_tp'])) {
//     die('Subkategori tidak dipilih.');
// }
...
$subkategori_tp = mysqli_real_escape_string($server, $_POST['subkategori_tp']);
...
$insert_product_adm = $server->query("INSERT INTO `iklan`(`id_kategori`,`id_subkategori`, `gambar`, `judul`, `harga`, `deskripsi`, `berat`, `warna`, `ukuran`, `stok`, `waktu`) VALUES ('$kategori_tp','$subkategori_tp', '$name_gambar', '$judul_tp', '$harga_tp', '$deskripsi_tp', '$berat_tp', '$varian_warna', '$varian_ukuran', '$stok_tp', '$time')");
