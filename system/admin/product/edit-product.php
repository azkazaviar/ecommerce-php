...
$subkategori_ep = mysqli_real_escape_string($server, $_POST['subkategori_ep']);
...
$edit_produk_adm = $server->query("UPDATE `iklan` SET `id_kategori`='$kategori_ep', `id_subkategori`='$subkategori_ep',`gambar`='$name_gambar',`judul`='$judul_ep',`harga`='$harga_ep',`deskripsi`='$deskripsi_ep',`berat`='$berat_ep',`warna`='$varian_warna',`ukuran`='$varian_ukuran',`stok`='$stok_ep' WHERE `id`='$id_produk_ep' ");
